...
<template>
  <div class="hoteldetail-page">
    ...
    <div class="hotel-overview">
      ...
      <div class="hotelrating-avg">
        <div class="hotelrating-avg-now">

        </div>
        <div class="hoteloverview-1">

        </div>
        <div class="hoteloverview-2">

        </div>
        <div class="hoteloverview-3">

        </div>
        <div class="hoteloverview-4">
    ...
    <div class="hotel-leftrooms">
      ...
      <div class="leftroom-1">

      </div>
      <div class="leftroom-2">

      </div>
      <div class="leftroom-3">

      </div>
      <div class="leftroom-4">
